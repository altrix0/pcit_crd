...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_equipment']) && $show_form && !$deployment_load_error) {
    try {
        ...
        $stmt->execute([
            $pw_no, $year, $serial_number, $make, $model, 
            $modulation_type, $freq_band, $equipment_type, $equipment_status,
            $deployment_id, $unit_id, $_SESSION['user_id']
        ]);
...
<form action="dashboard.php?page=equipment" method="POST" class="needs-validation" novalidate>
    <div class="row">
        ...
        <div class="col-md-3 mb-3">
            ...
            <input type="text" class="form-control" id="year" name="year" placeholder="YYYY" 
                pattern="^(19|20)\d{2}$" required maxlength="4">
        ...
        <div class="col-md-6 mb-3">
            ...
            <select class="form-select" id="deployment" name="deployment" required>
                ...
                <option value="<?php echo $deployment['deployment_id']; ?>"><?php echo htmlspecialchars($deployment['deployment_name']); ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="unit_display" value="<?php echo htmlspecialchars($user_unit['unit_name'] . ' (' . $user_unit['unit_code'] . ')'); ?>" readonly>
    ...
    <div class="mt-4">
        <button type="submit" name="save_equipment" class="btn btn-custom">Save Equipment</button>
    </div>
